...
#define DEFINE_TEST_CASE(T)                                                   \
    ...
    {                                                                         \
        ...
        DEFINE_TEST_SECTION(T, ::dataframe::Opaque<int>)                         \
        DEFINE_TEST_SECTION(T, ::dataframe::Dict<int>)                        \
...
DEFINE_TEST_CASE(::dataframe::Opaque<int>)
DEFINE_TEST_CASE(::dataframe::Dict<int>)
