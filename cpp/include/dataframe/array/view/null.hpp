...
#ifndef DATAFRAME_ARRAY_VIEW_NULL_HPP
#define DATAFRAME_ARRAY_VIEW_NULL_HPP
  ...
  public:
    ...
    class iterator
    {
      public:
        ...
        reference operator*() const noexcept { return nullptr; }
    ...
    {
        if (dynamic_cast<const ::arrow::NullArray *>(data_.get()) == nullptr) {
            throw DataFrameException("Array is not of NULL type");
        }
    }
    ...
    const_reference operator[](size_type) const noexcept { return nullptr; }
    ...
    const_reference front() const noexcept { return nullptr; }

    const_reference back() const noexcept { return nullptr; }
    ...
    const_iterator end() const noexcept { return iterator(size_); }
...
#endif // DATAFRAME_ARRAY_VIEW_NULL_HPP
